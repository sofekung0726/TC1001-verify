...
WebUI.click(findTestObject('Registerpage/addresss_invoice_option2'))

WebUI.verifyElementClickable(findTestObject('Registerpage/invoice_name'))

WebUI.setText(findTestObject('Registerpage/birthday_in'), '13/02/2546')

WebUI.sendKeys(findTestObject('Registerpage/birthday_in'), Keys.chord(Keys.ENTER))

autoage = WebUI.getAttribute(findTestObject('Registerpage/autoage'), 'value')
